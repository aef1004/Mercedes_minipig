...
fitted_models_CD8_r1 <- fit_models(random_flow_metabolites_1, "CD8")
p_hist(fitted_models_CD8_r1, "CD8")

fitted_models_CD8_r2 <- fit_models(random_flow_metabolites_2, "CD8")
p_hist(fitted_models_CD8_r2, "CD8")

fitted_models_CD8_r3 <- fit_models(random_flow_metabolites_3, "CD8")
p_hist(fitted_models_CD8_r3, "CD8")
```

Plot the correlations with timepoints combined - basically when I run it with the similated data, there's  0-2 metabolites where the p-value < 0.01 and the r^2 >0.5!
```{r fig.width = 7, fig.height = 8}
important_metabs_SLADQ <- calc_important_metab(fitted_models_SLADQ_r2, 0.01, 0.5)

r_labels_SLADQ <- calculate_plot_r_labeling(important_metabs_SLADQ, random_flow_metabolites_2)

flow_metab_corr_plot(random_flow_metabolites_2, important_metabs_SLADQ, 
