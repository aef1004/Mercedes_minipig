...
plot_complex(minipig_PCA, "CD8_Tcell", "PC6", 75, 5, 10) 
plot_complex(minipig_PCA, "DN_Tcell", "PC9", 75, 5, 10) 
plot_complex(minipig_PCA, "Pop12", "PC2", 75, 5, 10) 
plot_complex(minipig_PCA, "Pop15", "PC2", 75, 5, 10) 
plot_complex(minipig_PCA, "Pop7", "PC2", 75, 5, 10) 
plot_complex(minipig_PCA, "Pop8", "PC2", 75, 5, 10) 
```
...
```{r}
lm_formula <- flow_percent ~ PC_value + timepoint
