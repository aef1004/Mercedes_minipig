...
p1 <- arrange_plot(flow_metab, "Pop24", "metab_1011",  25, 1.5E4, 1E4)
p2 <- arrange_plot(flow_metab, "Pop24", "metab_1081",  25, 2E4, 1E4)
p3 <- arrange_plot(flow_metab, "Pop24", "metab_1082",  25, 2E4, 1E4)
p4 <- arrange_plot(flow_metab, "Pop24", "metab_1083",  25, 2E4, 1E4)
p5 <- arrange_plot(flow_metab, "Pop24", "metab_1101",  25, 2E4, 1E4)
p6 <- arrange_plot(flow_metab, "Pop24", "metab_1102",  25, 2E4, 1E4)
p7 <- arrange_plot(flow_metab, "Pop24", "metab_1169",  25, 2E4, 1E4)
p8 <- arrange_plot(flow_metab, "Pop24", "metab_1186",  25, 2E4, 1E4)
p9 <- arrange_plot(flow_metab, "Pop24", "metab_1263",  25, 2E4, 1E4)
p10 <- arrange_plot(flow_metab, "Pop24", "metab_1280",  25, 2E4, 1E4)
p11 <- arrange_plot(flow_metab, "Pop24", "metab_3602",  25, 2E4, 1E4)
...
ggarrange(p1 + rremove("legend") + rremove("xlab"), 
          ...
          p10+ rremove("legend"), 
          ncol = 3, nrow = 4) %>%
  annotate_figure(top = text_grob("PC4 Linoleic acid metabolism and Pop24: CD3+ CD4+ CD8+ CD45RA+", size = 25))
...
p1 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1011",  25, 1.5E4, 1E4)
p2 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1081",  25, 2E4, 1E4)
p3 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1082",  25, 2E4, 1E4)
p4 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1083",  25, 2E4, 1E4)
p5 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1101",  25, 2E4, 1E4)
p6 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1102",  25, 2E4, 1E4)
p7 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1169",  25, 2E4, 1E4)
p8 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1186",  25, 2E4, 1E4)
p9 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1263",  25, 2E4, 1E4)
p10 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_1280",  25, 2E4, 1E4)
p11 <- arrange_plot(flow_metab, "CD8_Tcell", "metab_3602",  25, 2E4, 1E4)
...
ggarrange(p1 + rremove("legend") + rremove("xlab"), 
          ...
          p10+ rremove("legend"), 
          ncol = 3, nrow = 4) %>%
  annotate_figure(top = text_grob("PC4 Linoleic acid metabolism and CD8 Tcells", size = 25))
```
